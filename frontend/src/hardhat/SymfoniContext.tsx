...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const getJunkCoinDepositedERC20 = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const instance = _signer ? JunkCoinDepositedERC20__factory.connect(contractAddress, _signer) : JunkCoinDepositedERC20__factory.connect(contractAddress, _provider)
